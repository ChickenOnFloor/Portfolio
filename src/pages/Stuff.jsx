...
const Stuff = () => {
  ...
  return (
    <div className='stuff_parent w-full bg-white h-screen'>
        ...
        <div className='flex justify-center items-center flex-col h-4/6 p-2 gap-20 sm:gap-5'>
            <h1 className='heading text-xl sm:text-2xl md:text-4xl border-b-2 border-black mt-28 sm:mt-32 md:mt-40'>About Me</h1>
            ...
            <div className='flex justify-center flex-col sm:flex-row md:flex-row items-center cards w-full gap-5 sm:gap-5 md:gap-20 '>
                ...
                <div className='hidden sm:block relative card2 card w-8/12 max-w-[460px] h-44 sm:h-64 md:h-72  rounded-lg overflow-auto border-2 border-black'>
                    <div className='absolute flex justify-center items-center w-full h-2/12 sm:h-10 md:h-16 border-b-2 border-black'>
